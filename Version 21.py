...
# ===== 修复1：使用脚本所在目录，避免权限问题 =====
DATA_DIR = "/Users/hueyyyy/Studymate.py/data"
USERS_FILE = "/Users/hueyyyy/Studymate.py/data/users.json"
...
class DataManager:
    @staticmethod
    def load_users():
        file_path = "/Users/hueyyyy/Studymate.py/data/users.json"
    ...
    def save_all_users(users):
        ...
        try:
            ...
            print(f"✅ Saved {len(data)} users to {file_path}")
            return True
        except Exception as e:
...
class AuthWindow:
    ...
    def do_login(self):
        ...
        print(f"🔍 User '{username}' has {len(user.subjects)} subjects, {len(user.tasks)} tasks")
...
class MainApp:
    ...
    # ===== 修复缩进：add_subject 正确缩进在 MainApp 内部 =====
    def add_subject(self):
        ...
        try:
            ...
            DataManager.save_all_users(AuthWindow.users)
