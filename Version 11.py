...
# ============================================
def draw_logo(canvas, x, y, size=60, color="#6b46c1"):
    """
    Draw the StudyMate logo on a tkinter Canvas.
    Logo: A book with a star on top.
    """
    # Star on top
    star_points = [
        x, y - size * 0.7,
...
class AuthWindow:
    ...
    def setup_ui(self):
        ...
        title_frame = tk.Frame(self.root, bg=COLORS["accent"], height=140)
        title_frame.pack(fill="x")
        
        # Logo canvas inside title frame
        ...
        logo_canvas.pack(pady=(20, 0))
        draw_logo(logo_canvas, 40, 40, size=50, color="white")
