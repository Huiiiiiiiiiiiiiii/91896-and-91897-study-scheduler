...
def generate_plan():
    ...
    plan_display.insert(tk.END, "        YOUR DAILY STUDY PLAN\n")
    plan_display.insert(tk.END, "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n")
...
tk.Label(display_card, text="📋 CURRENT SUBJECTS", font=title_font,
          fg=COLORS["accent"], bg=COLORS["frame_bg"]).pack(anchor="w", padx=10, pady=(10, 5))
...
footer = tk.Label(root, text="© EGGS Study Scheduler | Stay organized, stay ahead!",
